...
using ParameterTuple = std::tuple<VerboseFlag, FileOption>;

TEST_CASE("Empty ValueContainer contains all std::nullopt", "[value_container]")
{
    SECTION("ValueContainer<Parsables...>")
    {
    ...
    SECTION("ValueContainer<std::tuple<Parsables...>>")
    {
        CLArgs::ValueContainer<ParameterTuple> container;
